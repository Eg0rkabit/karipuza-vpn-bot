...
android {
    ...
    defaultConfig {
        applicationId = "ru.karipuza.froxy"
        minSdk = 23
        targetSdk = 35
        versionCode = getVersionProps("VERSION_CODE").toInt()
        versionName = getVersionProps("VERSION_NAME")
        base.archivesName.set("Karipaza-Froxy-${versionName}")
        buildConfigField("String", "API_BASE_URL", "\"https://app.karipuza.ru\"")
        buildConfigField("String", "BOT_URL", "\"https://t.me/KaripuzaVPN_bot\"")
    }
